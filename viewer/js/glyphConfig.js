...
function glyphSettings()
{
    var out = [
        ...
        {gene:'Foxp2',color: '#5C148C',         glyphSymbol: 'v',  glyphName: 'triangleDown'},
        ...
        {gene:'Gpr101',color: '#d50000',  glyphSymbol: '<',  glyphName: 'triangleLeft'},
        ...
        {gene:'Pdyn',color: '#3ba949',  glyphSymbol: '*',  glyphName: 'asterisk'},
